...
{
    public class ApoliceSaudeTests
    {
        #region Context Creation
        ApplicationDbContext _db;
        IApoliceUtils _apoliceUtils;

        public ApoliceSaudeTests()
        {
        ...
        private void Seed(ApplicationDbContext context)
        {
            ...
            {
                new Apolice{ Id = 1, Ativa = true, Simulacao = "Pagamento Emitido", AgenteId = 1, Premio = 100, Fracionamento= "Mensal", SeguroId = 3 },
                new Apolice{ Id = 2, Ativa = false, Simulacao = "Aprovada", AgenteId = 1, Premio = 100, Fracionamento= "Mensal", SeguroId = 3 }
            };

            var ApoliceSaudeList = new List<ApoliceSaude>
            {
                new ApoliceSaude{ Id = 1,  ApoliceId= 1, ClienteId = 1},
                new ApoliceSaude{ Id = 2,  ApoliceId= 2, ClienteId = 2}
            };
            ...
            context.ApoliceSaudes.AddRange(ApoliceSaudeList);
            context.SaveChanges();
        }
        ...
        public void ApoliceSaude_ApoliceSaudeCreateValidValidade_ShouldCreateApoliceSaude(string? dataValidade)
        {
            //Arrange
            ...
            //Act
            var result = _apoliceUtils.CreateApoliceSaude(createAp, obj);

            //Assert
            Assert.IsType<ApoliceSaude>(result.Item2);
        ...
        public void ApoliceSaude_ApoliceSaudeCreateValidValidade_ShouldReturnNull(string? dataValidade)
        {
            //Arrange
            DateTime? expectedDate = null;
            if (dataValidade != null) expectedDate = DateTime.Parse(dataValidade);
        ...
        public void ApoliceSaude_ApoliceSaudeCreateValidSeguro_ShouldCreateApoliceSaude(int seguroId)
        {
            //Arrange
        ...
        public void ApoliceSaude_ApoliceSaudeCreateValidSeguro_ShouldReturnNull(int? seguroId)
        {
            //Arrange
        ...
        public void ApoliceSaude_ApoliceSaudeCreateValidCobertura_ShouldCreateApoliceSaude(int[] coberturasId)
        {
            //Arrange
            var createAp = new ApoliceSaude();
        ...
        public void ApoliceSaude_ApoliceSaudeCreateValidCobertura_ShouldReturnNull(int[] coberturasId)
        {
            //Arrange
            var createAp = new ApoliceSaude();
